...
function StopSwatch({
  ...
  return (
    ...
    >
      {/* Color swatch */}
      <div
        className="h-7 w-7 shrink-0 rounded border border-neutral-700"
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center gap-1.5">
          ...
          {isBase && (
            <span className="rounded bg-neutral-700 px-1 py-0.5 text-[10px] font-medium leading-none text-neutral-300">
              base
            </span>
          )}
          {stop.overridden && (
            <button
              ...
              className="rounded bg-amber-900/60 px-1 py-0.5 text-[10px] font-medium leading-none text-amber-300 hover:bg-amber-900/80"
...
function OverrideSliders({
  ...
  return (
    <div className="ml-2 flex flex-col gap-2 rounded-md border border-neutral-800 bg-neutral-900/50 px-3 py-2.5">
      ...
      <div className="flex flex-col gap-0.5">
        ...
        <input
          ...
          className="h-1 w-full cursor-pointer appearance-none rounded-full bg-neutral-700 accent-neutral-400"
...
export function StopStrip({ ramp, onOverride, onClearOverride }: StopStripProps) {
  ...
  return (
    <div className="flex flex-col gap-1">
      <p className="text-xs font-medium text-neutral-400">Stops</p>
      <div className="flex flex-col gap-0.5">
        {ramp.stops.map((stop) => (
          <div key={stop.id}>
            <StopSwatch
